# Onda 6 — Refatorações Estruturais

> ⛔ **`NO-GO` até:** Ondas 1–3 aprovadas **+** TST-001.b e TST-002 verdes **+** decisão **D-3** registrada.

## Resumo Executivo

**Objetivo:** Aposentar o legado, quebrar monólitos e granular render.
**Achados:** 8 · **Esforço relativo:** Muito Grande · **Marco de conclusão:** **M7 — Arquitetura consolidada**
**Prioridades nesta onda:** P1: 5 · P2: 1 · P3: 2

## Objetivo

Aposentar o legado, quebrar monólitos e granular render.
...
A onda encerra ao satisfazer o [Checklist de Conclusão](10_Checklist_Conclusao.md) e tagear o marco **M7**.
