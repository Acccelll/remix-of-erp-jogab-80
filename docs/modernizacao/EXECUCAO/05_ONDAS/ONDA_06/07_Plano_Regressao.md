...
### Regressão específica da Onda 6

| Fluxo / Verificação                           | Módulos          | Tipo de teste    | Nível de regressão |
| --------------------------------------------- | ---------------- | ---------------- | ------------------ |
| Abrir/editar card e obra (paridade funcional) | M2, M3           | E2E + component  | Alto               |
| Domínios migrados do god-context              | M1, M9, M10, M13 | E2E + integração | Muito Alto         |
| DP com fonte única (histórico preservado)     | M9               | Integração       | Muito Alto         |
