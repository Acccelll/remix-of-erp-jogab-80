# Onda 5 — Validação e Regras

## Resumo Executivo

**Objetivo:** Validação única e regras de negócio sem duplicação.
**Achados:** 6 · **Esforço relativo:** Grande · **Marco de conclusão:** **M6 — Regras e fluxo financeiro consolidados**
**Prioridades nesta onda:** P1: 5 · P2: 1

## Objetivo

Validação única e regras de negócio sem duplicação.

## Escopo

Esta onda entrega os 6 Achados listados em [02_Achados.md](02_Achados.md). Nenhum deles depende de item em onda posterior.
...
A onda encerra ao satisfazer o [Checklist de Conclusão](10_Checklist_Conclusao.md) e tagear o marco **M6**.
