...
**Objetivo:** Fronteira íntegra e camada de dados fechada e testada.
**Achados:** 8 · **Esforço relativo:** Grande · **Marco de conclusão:** **M4 — Dados e camadas consolidados**
**Prioridades nesta onda:** P1: 5 · P2: 2 · P3: 1

## Objetivo

Fronteira íntegra e camada de dados fechada e testada.
...
A onda encerra ao satisfazer o [Checklist de Conclusão](10_Checklist_Conclusao.md) e tagear o marco **M4**.
